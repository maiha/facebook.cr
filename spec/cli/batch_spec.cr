...
private def current_url
  "https://graph.facebook.com/v23.0/act_123/campaigns?access_token=xxx&fields=id%2Cname&limit=100&after=abc"
end
...
describe Cmds::BatchCmd::ReduceData do
  describe ".update_limit(url, limit)" do
    it "replace limit parameter" do
      Cmds::BatchCmd::ReduceData.update_limit(current_url, 10).should eq "https://graph.facebook.com/v23.0/act_123/campaigns?access_token=xxx&fields=id%2Cname&limit=10&after=abc"
    end
  ...
  describe ".reduce_data(current_url, min_limit)" do
    it "builds reduced_url by setting limit to limit/2" do
      reduce_data(current_url, 10).should eq "https://graph.facebook.com/v23.0/act_123/campaigns?access_token=xxx&fields=id%2Cname&limit=50&after=abc"
    end

    it "respects min_limit" do
      reduce_data(current_url, 99).should eq "https://graph.facebook.com/v23.0/act_123/campaigns?access_token=xxx&fields=id%2Cname&limit=99&after=abc"
    end
